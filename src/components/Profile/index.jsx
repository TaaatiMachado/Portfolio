    ...
    return (
        <>
            <div className=' max-w-[1440px] mx-auto pt-10' id='profile'>
                ...
                <div className='flex flex-col-reverse justify-around items-center lg:px-12 md:flex-row'>
                    ...
                    <p className='text-md my-0 p-5 md:max-w-[50%]'>Passionate about the intersection of art and technology, I have gained valuable experience as a front-end developer,
