...
const CarouselItem = ({img, url, title}) => {
    return (
        <div className="flex items-center flex-col relative bg-lightest-purple bg-opacity-20 mx-5 my-10 rounded-lg shadow-lg w-[90%] max-w-[960px] cursor-default border-dashed border border-white" >
